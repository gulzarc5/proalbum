    ...
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.frve ? a.options.watermarkcode = "<a style='text-decoration:none; display:none;'>" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none; display:none' target='_blank' href='" + a.options.watermarklink + "' >");
                a.options.watermarkcode +=
                    "<div class='html5gallery-watermark-" + a.id + "' " + "style=display:none!important;" +"  >";
            ...
            createStyleVertical: function() {
                ...
                var d = d + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center;  top:" + this.options.boxTop + "px;}"),
                    ...
                    d = d + (" .html5gallery-title-" + this.id + " {display:none; overflow:hidden;"),
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    b(e).on("load", function() {
                        ...
                        var d = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height),
                            ...
                            '"' : "";
                        a.options.carouselmultirows && "samecolumn" == a.options.thumbresponsive ? b("#html5gallery-tn-" + a.id + "-" + this.data, c).append("<div class='html5gallery-tn-img-" + a.id + "'" + g + " style='position:relative;width:100%;height:" + String(a.options.thumbimageheight + 2 * a.options.thumbimageborder) + "px;'><div style='display:block; overflow:hidden; position:absolute; width:" + a.options.thumbimagewidth + "px;height:" + a.options.thumbimageheight + "px; top:" +
                            ...
                            h + "</div>") : b("#html5gallery-tn-" + a.id + "-" + this.data, c).append("<div class='html5gallery-tn-img-" + a.id + "'" + g + " style='position:relative;'><div style='display:block; overflow:hidden; position:absolute; width:100%;height:" +
                            a.options.thumbimageheight + "px; top:" + a.options.thumbimageborder + "px; left:" + a.options.thumbimageborder + "px;'><img alt='" + a.html2Text(a.elemArray[this.data][25]) + "'" + (a.options.addimgtitle ? " title='" + a.html2Text(a.elemArray[this.data][7]) + "'" : "") + " data-originalwidth=" + this.width + " data-originalheight=" + this.height + " class='html5gallery-tn-image html5gallery-tn-image-" + a.id + "'" + g + " style='border:none; padding:0px; margin:0px; max-width:100%; max-height:none;' src='" +
