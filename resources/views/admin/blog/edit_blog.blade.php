	...
	<div class="col-md-12">
	    ...
	    <div class="x_panel">
	        ...
	        <div>
	            ...
	            <div class="x_content">
	            	{{ Form::open(['method' => 'put','route'=>['admin.update_blog',$blog->id],'enctype'=>'multipart/form-data']) }}
	            	<div class="well" style="overflow: auto">
                        <div class="form-row mb-10">
                            <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                <label for="title">Blog Title</label>
                                <input type="text" class="form-control" name="title"  placeholder="Enter Blog Title" id="name" value="{{$blog->title}}">
                                  @if($errors->has('title'))
                              ...
                              <div class="col-md-6 col-sm-12 col-xs-12 mb-3">
                                ...
                                <input type="text" class="form-control" id="slug" name="slug"  placeholder="Enter Tag Name" readonly value="{{$blog->title}}">
                                @if($errors->has('slug'))
                                    <span class="invalid-feedback" role="alert" style="color:red">
                        ...
                        <div class="form-row mb-10">
                            <div class="col-md-12 col-sm-12 col-xs-12 mb-3">
                              <label for="desc">Blog Body</label>
                                <textarea type="text" class="form-control" name="body" id="desc">{{$blog->body}}</textarea>
                               @if($errors->has('body'))
                                    <span class="invalid-feedback" role="alert" style="color:red">
