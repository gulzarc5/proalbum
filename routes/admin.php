...
Route::group(['namespace'=>'Admin','prefix'=>'admin'],function(){
    ...
    Route::group(['middleware'=>'auth:admin'],function(){
        ...
        Route::group(['prefix'=>'product'],function(){
            ...
            Route::get('status/update/{p_id}/{status}','ProductController@productStatusUpdate')->name('admin.product_status_update');
            Route::get('delete/{p_id}','ProductController@productDelete')->name('admin.product_delete');
